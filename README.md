...
### Backend & AI Engineer | Machine Learning | Data Science | Automação
...
Desenvolvedor focado em **Backend**, **AI Agents**, **Machine Learning** e **Automação**. Cursando 4º período em Ciência da Computação na CESAR School, com experiência em criar soluções inteligentes e escaláveis.
...
**Tech Stack:** Python • LangGraph • LangChain • Tavily API • Streamlit

---

### 💬 [Chatbot Educacional com LangChain](https://github.com/DaviSantiago01/Simple-Chatbot-LangChain)
Aplicação educacional demonstrando fundamentos de IA conversacional com interface web interativa e integração com LLM APIs.
